export const fakeFetchOneProduct = (url) => {
                    ...
                    data: {
                        products: [
                            ...
                            },
                            {
                                ...
                                inStock: true,
                                desc: "lorem ipsum dolor sit amit",
                                src: "https://media.istockphoto.com/id/1213236556/photo/hiking-backpack-travel-gear-on-mountain-items-include-hiking-for-travel.jpg?s=1024x1024&w=is&k=20&c=eoTmAVp_DjX4QBa2CzDQAxt3CXd4mA-TTe-CsHLf0os=",
                            },
                        ],
                    },
                });
...
export const fakeFetchToDoTwo = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
                        ...
                        todos: [
                            {
                                title: "Go Outside",
                                desc: "lorem ipsum dolor sit amit",
                                todosList: ["shopping", "cricket", "walking"],
                            },
                            {
                                title: "Let's Work",
                                desc: "lorem ipsum dolor sit amit",
                            ...
                            },
                            {
                                title: "Home Work",
                                desc: "lorem ipsum dolor sit amit",
                                todosList: ["Fix tap", "Wedding function"],
                            },
                        ],
                    },
                });
...
export const fakeFetchThreeHabit = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
...
export const fakeFetchFourVideo = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
...
export const fakeFetchFivePost = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
                ...
                resolve({
                    ...
                    data: {
                        posts: [
                            ...
                            {
                                caption:
                                    "The best bread recipe you'll ever taste",
...
export const fakeFetchSixHabit = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            if (url === "https://example.com/api/habits") {
                resolve({
...
export const fakeFetchSevenProject = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
...
export const fakeFetchProfileEight = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
