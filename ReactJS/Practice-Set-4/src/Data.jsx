export const QuesOneCharactersData = {
    heroes: [
        {
            name: "IRON MAN",
...
export const QuesThreeItemListData = [
...
export const QuesFourTodoItemsData = [
...
export const QuesFiveTodoItemsData = [
