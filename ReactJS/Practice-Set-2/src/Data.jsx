export const QuesThreeUserData = {
    name: "John",
    age: 25,
    email: "john@example.com",
};

export const QuesFourProductsData = [
    {
        id: 1,
        name: "keyboard",
...
export const QuesFiveProductsData = [
    {
        id: 1,
        name: "keyboard",
        description: "Logitech Mechanical Keyboard",
...
export const QuesSixTitleData = "React is awesome";
export const QuesSixContentData =
    "React is a JavaScript library for building user interfaces.";

export const QuesSevenHeadingData = "About Me";
export const QuesSevenNameData = "clevercoderjoy"; // you can put your name
export const QuesSevenLearningData =
    "I am learning React JS currently at neoG Camp.";

export const QuesEightProductsData = [
    {
        id: 1,
        name: "keyboard",
        description: "Logitech Mechanical Keyboard",
...
export const QuesTenTodoItemsData = [
    {
        id: 1,
