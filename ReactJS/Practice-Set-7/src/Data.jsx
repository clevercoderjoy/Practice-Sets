export const fakeFetchWeatherOne = (url) => {
...
export const fakeFetchUserTwo = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
...
export const fakeFetchMoviesThree = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
...
export const fakeFetchUsersFour = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
...
export const fakeFetchQuoteFive = () => {
    const quotes = [
        {
...
export const fakeFetchMoviesSix = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            if (url === "https://example.com/api/movies") {
                resolve({
...
export const fakeFetchProductsSeven = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
...
export const fakeFetchProductNine = (url) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            if (url === "https://example.com/api/products") {
                resolve({
